...
static const unsigned short _modbus_CRCTab[256] = {
    ...
    0xC601, 0x06C0, 0x0780, 0xC741, 0x0500, 0xC5C1, 0xC481, 0x0440,    /* 0x08-0x0F */
...
int main(void)
{
    unsigned char testbuf[] = { 0xFE, 0x04, 0x00, 0x03, 0x00, 0x01, /* 0xD5, 0xC5 */ };
    unsigned short calc_crc = 0;

    calc_crc = modbus_CRC(testbuf,sizeof(testbuf));
    printf("CRC:0x%04x\n",calc_crc);

    /* modbus crc16 &#65533;&#769;A&#65533;&#65533;&#65533;o&#65533;C&#65533;g&#65533;&#65533;&#65533;&#29783;&#65533;M&#65533;&#65533;&#65533;ç·&#65533;&#65533; */
    return 0;
}
